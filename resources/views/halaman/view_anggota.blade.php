...
@section('isihalaman')
    <h3><center>Daftar Anggota DfA-Library</center></h3>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formanggotaedit" id="formanggotaedit" action="/anggota/edit/{{ $a->id_anggota}} " method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label for="id_anggota" class="col-sm-4 col-form-label">Nomor Anggota</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="nomor_anggota" name="nomor_anggota " placeholder="Masukan Nomor Anggota">
                                                </div>
                                            </div>
                                            ...
                                            <p>
                                            <div class="form-group row">
                                                <label for="prodi" class="col-sm-4 col-form-label">Status</label>
                                                <div class="col-sm-8">
                ...
                <div class="modal-body">
                    <form name="formanggotatambah" id="formanggotatambah" action="/anggota/tambah " method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="status" name="status" placeholder="Masukan Status Anda">
                            </div>
                        </div>
